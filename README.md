...
- `/` — landing one-page (sections dans `components/home/` : Hero, Problem,
  HowItWorks, WhatsIncluded, WhySubscription, Proof, Pricing, Faq, FinalCta).
...
- **Formulaire de prise de RDV** (`components/home/FinalCta.astro`) —
